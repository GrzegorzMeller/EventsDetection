"""
Code is based on https://nlp.stanford.edu/projects/glove/ GitHub repository
...
if __name__ == '__main__':
    ...
    with Path('D:\\projects\\inf_retrieval\\datasets\\glove_big\\glove.840B.300d.txt').open(encoding="utf8") as f:
